...
import main.java.org.baeldung.persistence.dao.PasswordResetTokenRepository;
import main.java.org.baeldung.persistence.dao.RoleRepository;
import main.java.org.baeldung.persistence.dao.UserRepository;
import main.java.org.baeldung.persistence.dao.VerificationTokenRepository;
...
public class UserService implements IUserService {
    ...
    public User registerNewUserAccount(final UserDto accountDto) {
        ...
        user.setOrganisation(accountDto.getOrganisation());
        user.setPassword(passwordEncoder.encode(accountDto.getPassword()));
        user.setEmail(accountDto.getEmail());
        user.setUsing2FA(accountDto.getUsing2FA());
        user.setRoles(Arrays.asList(roleRepository.findByName("ROLE_PUBLIC")));
